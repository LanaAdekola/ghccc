...
Sign in at /admin/login using your individual account. Use Forgot your password if needed.
Choose Create content, select a content type, and use a short lowercase hyphenated slug.

- Sermon: title, description, body, YouTube HTTPS URL, date and speaker.
- Event: title, description, date and venue. Registration interest currently goes to Contact; this is not completed event registration.
- Service schedule: location, day, start/end in HH:MM and Africa/Lagos timezone.
...
An existing slug should stay unchanged once shared. Automatic redirects for renamed content are not implemented; ask the site maintainer before changing it.
